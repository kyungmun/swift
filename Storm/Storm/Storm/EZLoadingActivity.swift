...
public struct EZLoadingActivity {
    ...
    public struct Settings {
        public static var BackgroundColor = UIColor(red: 227/255, green: 232/255, blue: 235/255, alpha: 0.8)
        ...
        public static var ActivityHeight = ActivityWidth / 4
    ...
    fileprivate class LoadingActivity: UIView {
        ...
        convenience init(text: String, disableUI: Bool) {
            ...
            let yPosition = frame.height / 2 - 15
            
            activityView = UIActivityIndicatorView(style: UIActivityIndicatorView.Style.whiteLarge)
            activityView.frame = CGRect(x: 20, y: yPosition, width: 30, height: 30)
            activityView.color = Settings.ActivityColor
            activityView.startAnimating()
            
            textLabel = UILabel(frame: CGRect(x: 30, y: yPosition - 5, width: Settings.ActivityWidth - 70, height: 40))
            textLabel.textColor = Settings.TextColor
            textLabel.font = UIFont(name: Settings.FontName, size: 16)
