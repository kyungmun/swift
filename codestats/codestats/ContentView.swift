...
struct ContentView: View {
    @State var redLightColor: Bool = true
    @State var yellowColor: Bool = false
    @State var greenColor: Bool = false
    var body: some View {
        VStack {
            Text("Traffic")
                .font(.title)
            Circle()
                .foregroundColor(redLightColor ? .red : .gray)
            Circle()
                .foregroundColor(yellowColor ? .yellow : .gray)
            Circle()
                .foregroundColor(greenColor ? .green : .gray)
            HStack{
                Button("빨강") {
                    redLightColor = true
                    yellowColor = false
